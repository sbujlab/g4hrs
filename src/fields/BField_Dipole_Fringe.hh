...
//
//
// $Id: BField_Dipole_Fringe.hh 69786 2013-05-15 09:38:51Z gcosmo $
//
//
// class BField_Dipole_Fringe
//
// Class description:
//
...
#ifndef BFIELD_DIPOLE_FRINGE_HH
#define BFIELD_DIPOLE_FRINGE_HH

#include "G4MagneticField.hh"
#include "G4ThreeVector.hh"
#include "G4RotationMatrix.hh"

class BField_Dipole_Fringe : public G4MagneticField
{
  public: // with description

    BField_Dipole_Fringe(G4double          pBend);
    BField_Dipole_Fringe(G4double          pBend, 
		  G4ThreeVector     pOrigin,
		  G4RotationMatrix* pMatrix);
   ~BField_Dipole_Fringe();
