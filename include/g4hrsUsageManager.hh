...
#    g4hrsUsageManager::Getparameter(string name, T &para);
#Enjoy! 
#########################################################################
*/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef _USAGET_H_
...
class g4hrsUsageManager
{
public: 
	//Static method which returns the singleton pointer of g4hrsUsageManager or its derived class.
	static g4hrsUsageManager* GetUsageManager();
private:
	static g4hrsUsageManager* fUsageManager;

public: 
	//thie construction of this class
	g4hrsUsageManager(const char *inifile="Usage.ini");
	virtual ~g4hrsUsageManager();
...
typedef g4hrsUsageManager UsageT;
typedef g4hrsUsageManager BonusUsage;
