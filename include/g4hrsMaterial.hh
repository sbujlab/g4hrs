// ********************************************************************
// $Id: g4hrsMaterial.hh,v 1.0, 2010/12/26 HRS Exp $
// --------------------------------------------------------------
//

#ifndef g4hrsMaterial_h
#define g4hrsMaterial_h 1
...
public:
	g4hrsMaterial();
	virtual ~g4hrsMaterial();
	G4Material* FindMaterial(G4String name);

	//Static method which returns the singleton pointer of this class.
	static g4hrsMaterial* GetHRSMaterialManager();

private:
	static g4hrsMaterial* fHRSMaterialManager;
...
typedef g4hrsMaterial g4hrsMaterialManager;
